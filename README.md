...
> The interactive physics simulation is available online. You can test the hosted playground here: [https://luisapr1.github.io/PhysicsEngine/](https://luisapr1.github.io/PhysicsEngine/).

An interactive 2D physics engine built from scratch using p5.js, implementing rigid body dynamics, AABB collision detection, and Verlet integration for stable simulations.
...
- This project was created for educational and personal exploration purposes.  
- [p5.js](https://p5js.org/) for the rendering framework  
- [Euler vs Verlet article](http://kahrstrom.com/gamephysics/2011/08/03/euler-vs-verlet/) for physics integration reference
